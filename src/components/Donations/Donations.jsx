...
const Donations = ({ item }) => {
  const { id, image, title, category, category_bg_color, card_bg_color, text_color } = item || {}
  // console.log(item);
  ...
  return (
    <div>
      <Link to={`/donations/${id}`}>
        <button>
          <div className=" mt-3 relative flex w-96 md:w-[360px] lg:w-64 flex-col rounded-xl bg-clip-border text-gray-700 shadow-md px-2 lg:px-0" style={bgColor}>
